...
module e203_soc_top(
 ...
 e203_subsys_top u_e203_subsys_top(
  ...
  .sysmem_icb_cmd_valid(icb_custom_mig_cmd_valid),
  .sysmem_icb_cmd_ready(icb_custom_mig_cmd_ready),
  .sysmem_icb_cmd_read (icb_custom_mig_cmd_read), 
  .sysmem_icb_cmd_addr (icb_custom_mig_cmd_addr), 
  .sysmem_icb_cmd_wdata(icb_custom_mig_cmd_wdata), 
  .sysmem_icb_cmd_wmask(icb_custom_mig_cmd_wmask), 

  .sysmem_icb_rsp_valid(icb_custom_mig_rsp_valid),
  .sysmem_icb_rsp_ready(icb_custom_mig_rsp_ready),
  .sysmem_icb_rsp_err  (1'b0  ),
  .sysmem_icb_rsp_rdata(icb_custom_mig_rsp_rdata),
