...
#
# Generated by export_simulation on Sun Jun 27 11:39:58 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './hdmi_ram_2.sh' script.

./hdmi_ram_2.sh -reset_run
...
./hdmi_ram_2.sh -noclean_files

For more information on the script, please type './hdmi_ram_2.sh -help'.
