...
assign s_ifmap_fifo_wr_en = s_conv2d_config_wren & ~w_icb_conv2d_en & (`CONV2D_IFWR_ADDR == conv2d_adr_i);
assign w_ifmap_fifo_data = s_ifmap_fifo_wr_en ? conv2d_dat_i[IFMAP_DATA_WIDTH-1:0] : {IFMAP_DATA_WIDTH{1'b0}};
